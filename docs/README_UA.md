...
Count Files - це кросплатформна програма, яка може бути встановлена з допомогою [pip](https://pip.pypa.io/en/stable/quickstart/):

```
pip3 install count-files
```

Поточну версію розробки проекту можна встановити з [`pip3 install -e`](https://pip.pypa.io/en/stable/reference/pip_install/#editable-installs).
...
Також можна підраховувати тільки загальну кількість файлів з певним розширенням.
...
Якщо вам потрібні всі файли, незалежно від їх розширення, використовуйте дві крапки як назву для розширення.
